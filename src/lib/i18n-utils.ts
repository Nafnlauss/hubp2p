 ...
 */
export function formatCurrency(amount: number, formatter: ReturnType<typeof useFormatter>): string {
 ...
 * Formatar percentual
 */
export function formatPercentage(value: number, formatter: ReturnType<typeof useFormatter>): string {
 ...
 */
export function formatDecimal(value: number, formatter: ReturnType<typeof useFormatter>, digits = 2): string {
  return formatter.number(value, {
 ...
 */
export function formatDateLong(date: Date, formatter: ReturnType<typeof useFormatter>): string {
 ...
 */
export function formatDateShort(date: Date, formatter: ReturnType<typeof useFormatter>): string {
  return formatter.dateTime(date, {
    year: 'numeric',
    month: '2-digit',
    day: '2-digit',
 ...
 */
export function formatDateTime(date: Date, formatter: ReturnType<typeof useFormatter>): string {
  return formatter.dateTime(date, {
    year: 'numeric',
    month: '2-digit',
    day: '2-digit',
 ...
 */
export function formatTime(date: Date, formatter: ReturnType<typeof useFormatter>): string {
  return formatter.dateTime(date, {
    hour: '2-digit',
    minute: '2-digit',
    second: '2-digit',
 ...
 */
export function formatTimeAgo(date: Date, formatter: ReturnType<typeof useFormatter>): string {
  const now = new Date();
 ...
 */
export function formatLargeNumber(value: number, formatter: ReturnType<typeof useFormatter>): string {
  return formatter.number(value, {
    minimumFractionDigits: 0,
 ...
 */
export function getLocalesWithNames(): Array<{ code: Locale; name: string; flag: string }> {
